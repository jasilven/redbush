...
// pub struct Nrepl {
//     pub sender: NreplSender,
//     pub receiver: NreplReceiver,
// }

// impl Nrepl {
//     pub fn new(host: &str, port: &str) -> Result<Nrepl> {
//         log::debug!("Connecting nREPL {}:{}", host, port);
...
// fn sender(&self) -> NreplSender {
//     self.sender
// }
// fn receiver(&self) -> NreplReceiver {
//     self.receiver
// }
// }
